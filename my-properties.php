...
$startRow_Recordset1 = $p * $maxRows_Recordset1;
    ...
    $my_id = $_SESSION['user'];
    $query_Recordset1 = "SELECT * FROM real_properties WHERE agent_id = '$my_id' ORDER BY id DESC";
...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title><?php echo ucfirst($class->getVariable('site_name')); ?> | My Properties</title>
                                ...
                                if ($n == 0) {
                                    echo '<div class="col-sm-12 p0">
                                            <div class="col-sm-12">
                                                ...
                                                <a href="submit-property.php">SUBMIT A PROPERTY</a>
                                            </div>
                                        </div>';
                                }else{
                                    do{
                                        echo '<div class="col-sm-6 col-md-4 p0" id="'.$row_Recordset1['id'].'">
                                                <div class="box-two proerty-item">
                                                    ...
                                                    <div class="item-entry overflow">
                                                        ...
                                                        <div class="property-icon">
                                                            ...
                                                            <span class="fa fa-trash" id="del_'.$row_Recordset1['id'].'" onClick=prompt_delete_property("'.$row_Recordset1['id'].'") style="font-size:22px;color:red;cursor:pointer" title="Delete"></span> 
                                                            &nbsp;&nbsp;<a href="edit-property.php?n='.$row_Recordset1['slug'].'"><span class="fa fa-edit" style="font-size:24px;cursor:pointer" title="Edit"></span></a> 
                                                        </div>
                                                    </div>
